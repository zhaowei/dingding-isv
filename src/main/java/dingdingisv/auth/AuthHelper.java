...
public class AuthHelper {
     ...
     * 具体信息请查看开发者文档--权限验证配置
     */
    public static String getAccessToken(String corpId, String permanentCode, String suiteToken) throws Exception {
    ...
    public static String getConfig(HttpServletRequest request) {
        ...
        try {
            String permantCode = "";
            String suiteToken = "";
            accessToken = AuthHelper.getAccessToken(corpId, permantCode, suiteToken);
    ...
    public static String getAgentId(String corpId, String appId) throws OApiException {
        ...
        args.put("suite_key", Constants.SUITE_KEY);
    ...
    public static String getSsoToken() throws OApiException {
        String url = "https://oapi.dingtalk.com/sso/gettoken?corpid=" + Constants.CORP_ID + "&corpsecret=" + Constants.SSO_Secret;
