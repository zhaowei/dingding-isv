...
import dingdingisv.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("dingdingisv.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("dingdingisv.repository.search")
